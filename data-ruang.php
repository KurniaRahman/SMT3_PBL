        ...
        <div class="flex items-center ms-3">
          <div>
            <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-600"
              aria-expanded="false" data-dropdown-toggle="dropdown-user" data-dropdown-placement="left-end">
          ...
          <div
            class="z-50 hidden my-4 text-base list-none divide-y rounded shadow bg-gray-700 divide-gray-600 md:min-w-32"
            id="dropdown-user">
            ...
            <ul class="py-1" role="none">
              ...
              <li>
                <a href="#" class="block px-4 py-2 text-sm text-red-500 hover:bg-gray-600 hover:text-red-400"
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="index.html" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 group">
            <svg class="w-5 h-5 text-white transition duration-75 group-hover:text-gray-800" aria-hidden="true"
        ...
        <li>
          <button type="button"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="flex-shrink-0 w-5 h-5 text-white transition duration-75 group-hover:text-gray-900">
            ...
            <svg class="w-3 h-3 text-white transition duration-75 group-hover:text-gray-900" aria-hidden="true"
          ...
          <ul id="dropdown-example" class="hidden py-2 space-y-2">
            <li>
              <a href="data-dosen.html"
                class="flex items-center w-full p-2 text-white hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                Dosen</a>
            </li>
            <li>
            ...
            <li>
              <a href="data-mahasiswa.html"
                class="flex items-center w-full p-2 text-white hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                Mahasiswa</a>
            </li>
            <li>
              <a href="data-matkul.html"
                class="flex items-center w-full p-2 text-white hover:text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100">Data
                Mata Kuliah</a>
            </li>
            <li>
              <a href="data-ruang.html"
                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group bg-gray-100">Data
                Ruang</a>
            </li>
          </ul>
        </li>
        <li>
          <a href="rekap.html" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 group">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="w-5 h-5 text-white transition duration-75 group-hover:text-gray-800">
              <path fill-rule="evenodd"
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-500">
        ...
        <li>
          <a href="#" class="flex items-center p-2 text-red-500 rounded-lg hover:bg-gray-100 group">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="w-5 h-5 text-red-500 transition duration-75 group-hover:text-gray-800">
              <path fill-rule="evenodd"
      ...
      <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
        <div
          ...
          <button
            ...
            type="button" data-modal-target="create-modal" data-modal-toggle="create-modal">
          ...
          <tbody>
            ...
            foreach ($db->tampil_ruang('ruang') as $x) {
              ...
              <tr class="border-b">
                ...
                <td class="px-4 py-3">
                  <span
                    class="<?php echo $x['keterangan'] == '1' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'; ?> text-xs font-medium me-2 px-2.5 py-0.5 rounded">
        ...
        <ul class="inline-flex items-stretch -space-x-px">
          ...
          <li>
            <a href="#" aria-current="page"
              class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-gray-600 bg-gray-50 border border-gray-300 hover:bg-gray-100 hover:text-gray-700">3</a>
          </li>
          <li>
            <a href="#"
  ...
  <div class="relative p-4 w-full max-w-2xl max-h-full">
    ...
    <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
      ...
      <form action="edit_ruang.php" method="POST">
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-2">
          <div>
            <label for="edit-nama" class="block mb-2 text-sm font-medium text-gray-900">Nama Ruang</label>
            <input type="text" name="nama" id="edit-nama"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5"
              required />
          </div>
          <div>
            <label for="edit-keterangan" class="block mb-2 text-sm font-medium text-gray-900">Keterangan</label>
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-4 md:p-5 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="size-12 text-red-600 mx-auto mb-4">
              <path fill-rule="evenodd"
                d="M9.401 3.003c1.155-2 4.043-2 5.197 0l7.355 12.748c1.154 2-.29 4.5-2.599 4.5H4.645c-2.309 0-3.752-2.5-2.598-4.5L9.4 3.003ZM12 8.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V9a.75.75 0 0 1 .75-.75Zm0 8.25a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"
                clip-rule="evenodd" />
            </svg>
            <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin ?</h3>
            <button onclick="window.location.href='hapus_ruang.php?id=1;" data-modal-hide="popup-modal" type="button"
